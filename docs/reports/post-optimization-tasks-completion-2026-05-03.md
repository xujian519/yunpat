...
2. **Logger测试**: [packages/cli/src/utils/__tests__/logger.test.ts](packages/cli/src/utils/__tests__/logger.test.ts)
3. **错误处理测试**: [packages/cli/src/utils/__tests__/errors.test.ts](packages/cli/src/utils/__tests__/errors.test.ts)
4. **框架命令测试**: [packages/cli/src/commands/__tests__/framework-commands.test.ts](packages/cli/src/commands/__tests__/framework-commands.test.ts)
