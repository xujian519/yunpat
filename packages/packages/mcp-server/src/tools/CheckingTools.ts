...
export class UnityCheckerTool extends BaseMcpTool<z.infer<typeof unityCheckSchema>, any> {
  readonly metadata = {
    name: 'unity_check',
    description:
...
export class TechUnitExtractorTool extends BaseMcpTool<z.infer<typeof techUnitSchema>, any> {
  readonly metadata = {
