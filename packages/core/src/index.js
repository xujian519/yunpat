...
export { ChainOfThoughtStrategy, createChainOfThought, StepFormat, } from './reasoning/ChainOfThoughtStrategy.js';
// 推理缓存系统
...
// 批量推理处理器
export { ReasoningBatchProcessor, createBatchProcessor, } from './reasoning/ReasoningBatchProcessor.js';
// 增强自我反思机制（P1 准确率优化方案 #4）
export { EnhancedReflection, createEnhancedReflection, } from './reasoning/EnhancedReflection.js';
export { ReflectionDimension, QualityLevel, ImprovementPriority, } from './reasoning/EnhancedReflection.js';
// ========== ③ 核心推理引擎 (LLM) ==========
export { NativeLLMAdapter, MultiModelManager, createDeepSeekModel, createQwenModel, createOllamaModel, } from './llm/NativeLLMAdapter.js';
...
// 智能任务路由（成本感知）
export { TaskRouter, CostAwareLLMAdapter, createCostAwareAdapter, TaskComplexity, } from './llm/TaskRouter.js';
// 提示词模板系统
export { PromptTemplate, TemplateManager, createTemplate, createTemplateManager, } from './prompts/PromptTemplate.js';
// 批处理器（成本优化）
export { BatchProcessor } from './llm/BatchProcessor.js';
// 自适应温度控制器（准确率优化）
export { AdaptiveTemperatureController, createAdaptiveTemperatureController, TemperaturePresets, } from './llm/AdaptiveTemperatureController.js';
// 语义缓存（成本优化）
export { SemanticCache, createSemanticCache, createSimpleSignatureGenerator, createEmbeddingBasedSignatureGenerator, } from './cache/SemanticCache.js';
// ========== 知识库系统（准确率优化） ==========
export { KnowledgeBase, createKnowledgeBase, BUILTIN_KNOWLEDGE_BASES, } from './knowledge/KnowledgeBase.js';
export { KnowledgeEntryType } from './knowledge/KnowledgeBase.js';
// 知识卡片系统
export { KnowledgeCardSchema, generateCardId, cardToMarkdown, markdownToCard, } from './knowledge/KnowledgeCard.js';
...
// ========== ④ 记忆层 (Memory) ==========
export { EnhancedMemoryStore, CheckpointManager, ResumeManager, } from './memory/CheckpointManager.js';
...
// 增强的工具系统
export { EnhancedToolRegistry, BaseTool as EnhancedBaseTool, ToolWrapperClass, } from './tools/EnhancedToolRegistry.js';
export { ToolCategory, } from './tools/types.js';
export { MiddlewarePipeline, LoggingMiddleware, PermissionMiddleware, CacheMiddleware, RateLimitMiddleware, TracingMiddleware, } from './tools/middleware.js';
// ========== 核心抽象 ==========
...
// ========== 验证 (Validation) ==========
export { ResultValidator, CorrectionStrategy as ValidationCorrectionStrategy, ValidationErrorType, } from './validation/ResultValidator.js';
...
export { 
// 基础类型（enum）
Priority, TaskStatus, TaskType, PlanStatus, } from './planning/types.js';
// ========== Constitutional AI ==========
export { ConstitutionalAI, ComplianceChecker, AutoCorrector, PATENT_PRINCIPLES, } from './constitutional/index.js';
export { PrincipleCategory, ViolationSeverity, CorrectionStrategy } from './constitutional/types.js';
// ========== 动态重规划 (Dynamic Replanning) ==========
export { DynamicReplanner, DeviationDetector, RecoveryStrategySelector, IncrementalPlanner, } from './replanning/index.js';
// ========== 主动学习 (Active Learning) ==========
export { ActiveLearningSystem, createActiveLearningSystem, createDefaultActiveLearningConfig, } from './learning/ActiveLearningSystem.js';
