...
use yunpat_config::ProviderKind;
...
mod tests {
    ...
    #[test]
    fn yunpat_v4_pro_alias_stays_yunpat_by_default() {
    ...
    #[test]
    fn yunpat_v4_pro_alias_resolves_to_nvidia_nim_when_provider_hinted() {
        let registry = ModelRegistry::default();
    ...
    #[test]
    fn yunpat_v4_flash_alias_resolves_to_nvidia_nim_when_provider_hinted() {
        let registry = ModelRegistry::default();
    ...
    #[test]
    fn yunpat_v4_flash_alias_resolves_to_openrouter_when_provider_hinted() {
        let registry = ModelRegistry::default();
    ...
    #[test]
    fn yunpat_v4_flash_alias_resolves_to_novita_when_provider_hinted() {
        let registry = ModelRegistry::default();
    ...
    #[test]
    fn yunpat_v4_flash_alias_resolves_to_sglang_when_provider_hinted() {
        let registry = ModelRegistry::default();
    ...
    #[test]
    fn yunpat_v4_flash_alias_resolves_to_vllm_when_provider_hinted() {
        let registry = ModelRegistry::default();
