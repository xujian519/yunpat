...
export class InventionUnderstandingAgent extends Agent {
    ...
    async plan(input, context) {
        ...
        try {
            ...
            console.log(`[InventionUnderstandingAgent] 交底书解析置信度: ${parsedDisclosure.confidence.toFixed(2)}, 特征数: ${extractedFeatures.features.length}`);
        }
        catch (e) {
            console.warn('[InventionUnderstandingAgent] patent-core 预处理失败，回退到纯 LLM 模式:', e.message);
        }
...
//# sourceMappingURL=InventionUnderstandingAgent.js.map