...
[![CI](https://github.com/xujian519/yunpat/actions/workflows/ci.yml/badge.svg)](https://github.com/xujian519/yunpat/actions/workflows/ci.yml)
...
│   ├── core/                # 核心框架（179个src文件，82个测试，~55,000行）
...
**项目规模**: ~470 个 TS 源文件，182 个测试文件，~126,000 行代码，20 个顶层包 + 30 个 agent 子包

### 已完成

| 模块                     | 完成度 | 说明                                                                               |
| ------------------------ | ------ | ---------------------------------------------------------------------------------- |
| 核心框架 (packages/core) | 95%    | 179 个 TS 文件，~55,000 行代码，82 个测试文件，Gateway 认证体系完成                |
