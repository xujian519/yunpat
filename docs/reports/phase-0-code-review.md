...
async function readFileWithTimeout(path: string, timeout: number = 5000): Promise<string> {
  const timeoutPromise = setTimeout(timeout, Promise.reject(new Error('Read timeout')))
