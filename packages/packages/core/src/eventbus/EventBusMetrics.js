...
export class EventBusMetrics {
   ...
   */
  setSlowEventThreshold(threshold) {
    this.slowEventThreshold = threshold
  }
}
//# sourceMappingURL=EventBusMetrics.js.map
