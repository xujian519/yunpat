...
pub enum MessageId {
    ...
    CmdUndoDescription,
    CmdYoloDescription,
    CmdResearchDescription,
    CmdDraftDescription,
    CmdOaDescription,
    CmdReexamDescription,
    CmdInvalidDescription,
    CmdTrademarkDescription,
    CmdCreativityDescription,
    CmdCaseDescription,
    CmdKbDescription,
    CmdPatentSearchDescription,
    CmdPaperSearchDescription,
    CmdPatentDbDescription,
    CmdOcrDescription,
    CmdDocxDescription,
    CmdCacheAdvice,
    CmdCacheFootnote,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CmdReexamDescription,
    ...
    MessageId::CmdDraftDescription,
    MessageId::CmdInvalidDescription,
    MessageId::CmdPatentDbDescription,
    MessageId::CmdOcrDescription,
    MessageId::CmdDocxDescription,
...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CmdResearchDescription => "Start a patent research workflow",
        MessageId::CmdDraftDescription => "Start a patent drafting workflow",
        MessageId::CmdOaDescription => "Start an Office Action response workflow",
        MessageId::CmdReexamDescription => "Start a reexamination workflow",
        MessageId::CmdInvalidDescription => "Start an invalidation workflow",
        MessageId::CmdTrademarkDescription => "Start a trademark workflow",
        MessageId::CmdCreativityDescription => "Start a creativity assessment workflow",
        MessageId::CmdCaseDescription => "Manage patent cases",
        MessageId::CmdKbDescription => {
            "Manage knowledge base documents (add, search, list, remove)"
        }
        MessageId::CmdPatentSearchDescription => {
            "Search patents via Google Patents or local database"
        }
        MessageId::CmdPaperSearchDescription => "Search academic papers via Semantic Scholar",
        MessageId::CmdPatentDbDescription => "Search local PostgreSQL patent database",
        MessageId::CmdOcrDescription => {
            "Extract text from image using OCR (requires --features ocr)"
        }
        MessageId::CmdDocxDescription => "Convert Markdown file to DOCX format",
        MessageId::CmdCacheAdvice => {
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdResearchDescription => "特許リサーチワークフローを開始",
        MessageId::CmdDraftDescription => "特許出願ドラフトワークフローを開始",
        MessageId::CmdOaDescription => "拒絶理由通知への応答ワークフローを開始",
        MessageId::CmdReexamDescription => "再審査ワークフローを開始",
        MessageId::CmdInvalidDescription => "無効審判ワークフローを開始",
        MessageId::CmdTrademarkDescription => "商標ワークフローを開始",
        MessageId::CmdCreativityDescription => "創造性評価ワークフローを開始",
        MessageId::CmdCaseDescription => "特許案件を管理",
        MessageId::CmdKbDescription => "知識ベースのドキュメントを管理（追加、検索、一覧、削除）",
        MessageId::CmdPatentSearchDescription => {
            "Google Patentsまたはローカルデータベースで特許を検索"
        }
        MessageId::CmdPaperSearchDescription => "Semantic Scholarで学術論文を検索",
        MessageId::CmdPatentDbDescription => "ローカルPostgreSQL特許データベースを検索",
        MessageId::CmdOcrDescription => {
            "OCRを使用して画像からテキストを抽出（--features ocrが必要）"
        }
        MessageId::CmdDocxDescription => "MarkdownファイルをDOCX形式に変換",
        MessageId::CmdCacheAdvice => {
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdResearchDescription => "启动专利研究工作流",
        MessageId::CmdDraftDescription => "启动专利撰写工作流",
        MessageId::CmdOaDescription => "启动审查意见答辩工作流",
        MessageId::CmdReexamDescription => "启动复审工作流",
        MessageId::CmdInvalidDescription => "启动无效宣告工作流",
        MessageId::CmdTrademarkDescription => "启动商标工作流",
        MessageId::CmdCreativityDescription => "启动创造性判断工作流",
        MessageId::CmdCaseDescription => "管理专利案件",
        MessageId::CmdKbDescription => "管理知识库文档（添加、搜索、列表、删除）",
        MessageId::CmdPatentSearchDescription => "通过 Google Patents 或本地数据库检索专利",
        MessageId::CmdPaperSearchDescription => "通过 Semantic Scholar 检索学术论文",
        MessageId::CmdPatentDbDescription => "检索本地 PostgreSQL 专利数据库",
        MessageId::CmdOcrDescription => "使用 OCR 从图片中提取文字（需要 --features ocr）",
        MessageId::CmdDocxDescription => "将 Markdown 文件转换为 DOCX 格式",
        MessageId::CmdCacheAdvice => {
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdResearchDescription => "Iniciar fluxo de pesquisa de patente",
        MessageId::CmdDraftDescription => "Iniciar fluxo de redação de patente",
        MessageId::CmdOaDescription => "Iniciar fluxo de resposta a exigência",
        MessageId::CmdReexamDescription => "Iniciar fluxo de reexame",
        MessageId::CmdInvalidDescription => "Iniciar fluxo de invalidação",
        MessageId::CmdTrademarkDescription => "Iniciar fluxo de marca registrada",
        MessageId::CmdCreativityDescription => "Iniciar fluxo de avaliação de criatividade",
        MessageId::CmdCaseDescription => "Gerenciar casos de patente",
        MessageId::CmdKbDescription => {
            "Gerenciar documentos da base de conhecimento (adicionar, pesquisar, listar, remover)"
        }
        MessageId::CmdPatentSearchDescription => {
            "Pesquisar patentes via Google Patents ou banco de dados local"
        }
        MessageId::CmdPaperSearchDescription => "Pesquisar artigos acadêmicos via Semantic Scholar",
        MessageId::CmdPatentDbDescription => {
            "Pesquisar banco de dados local de patentes PostgreSQL"
        }
        MessageId::CmdOcrDescription => {
            "Extrair texto de imagem usando OCR (requer --features ocr)"
        }
        MessageId::CmdDocxDescription => "Converter arquivo Markdown para formato DOCX",
        MessageId::CmdCacheAdvice => {
