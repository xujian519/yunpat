...
/// The bridge now uses `Arc<dyn LlmClient>` directly since the trait
/// is object-safe (all async methods return boxed futures as of the
/// v0.8.x LlmClient refactor).
