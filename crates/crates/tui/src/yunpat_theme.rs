...
impl Theme {
    ...
    pub const fn dark() -> Self {
        Self {
            ...
            section_bg: palette::YUNPAT_INK,
            section_title_color: palette::YUNPAT_BLUE,
    ...
    /// Light theme using the LIGHT_* palette colors.
    #[allow(dead_code)]
    #[must_use]
    pub const fn light() -> Self {
        Self {
            ...
            tool_running_accent: palette::YUNPAT_BLUE,
            tool_success_accent: palette::LIGHT_TEXT_HINT,
            tool_failed_accent: palette::YUNPAT_RED,
            plan_progress_color: palette::YUNPAT_BLUE,
            ...
            plan_completed_color: palette::YUNPAT_BLUE,
        }
    }
...
/// Returns the theme matching the given palette mode.
#[allow(dead_code)]
#[must_use]
pub const fn theme_for_mode(mode: crate::palette::PaletteMode) -> Theme {
    match mode {
        crate::palette::PaletteMode::Dark => Theme::dark(),
        crate::palette::PaletteMode::Light => Theme::light(),
    }
}
...
mod tests {
    ...
    fn dark_theme_matches_existing_palette_choices() {
        ...
        assert_eq!(theme.section_bg, palette::YUNPAT_INK);
        assert_eq!(theme.section_title_color, palette::YUNPAT_BLUE);
