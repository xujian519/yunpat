...
export class ToolDescriptionEnhancer {
   ...
   * 生成详细描述
   */
  generateDetailedDescription(tool) {
...
- 完整的错误处理
  ...
  extractUseCasesFromDescription(description) {
    const useCases = []
  ...
  generateDocxExamples(_metadata) {
    return [
      {
  ...
  generateExcelExamples(_metadata) {
    return [
      {
   ...
   * 生成工具描述文档
   */
  generateDocumentation(enhancedMetadata) {
    const lines = []
    lines.push('# 工具描述文档\n')
...
//# sourceMappingURL=ToolDescriptionEnhancer.js.map
