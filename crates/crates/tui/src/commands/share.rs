...
<title>云熙 TUI Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by 云熙 TUI · https://github.com/Hmbown/DeepSeek-TUI
</div>
</body>
</html>"#,
    )
