            ...
            claims: [
              {
                text: '声明',
                claimReview: [
                  { publisher: { name: 'A' }, url: 'http://a.com', textualRating: 'Accurate' },
                ],
              },
            ],
          }),
            ...
            claims: [
              {
                text: '声明',
                claimReview: [
                  { publisher: { name: 'A' }, url: 'http://a.com', textualRating: 'False' },
                ],
              },
            ],
          }),
            ...
            claims: [
              {
                text: '声明',
                claimReview: [
                  { publisher: { name: 'A' }, url: 'http://a.com', textualRating: 'Mixed' },
                ],
              },
            ],
          }),
            ...
            claims: [
              {
                text: '声明',
                claimReview: [
                  { publisher: { name: 'A' }, url: 'http://a.com', textualRating: '准确' },
                ],
              },
            ],
          }),
          ...
          Promise.resolve({
            claims: [
              ...
              },
              {
                text: '不同的声明内容',
                claimReview: [
                  { publisher: { name: 'B' }, url: 'http://b.com', textualRating: 'False' },
                ],
              },
            ],
          }),
