...
impl ToolRegistryBuilder {
    ...
    #[must_use]
    pub fn with_rlm_tool(self, client: Option<Arc<dyn LlmClient>>, root_model: String) -> Self {
    ...
    #[must_use]
    pub fn with_review_tool(self, client: Option<Arc<dyn LlmClient>>, model: String) -> Self {
    ...
    #[must_use]
    pub fn with_fim_tool(self, client: Option<Arc<dyn LlmClient>>, model: String) -> Self {
    ...
    /// Include all patent workflow tools from yunpat-agents.
    /// Registers each agent/tool as a separate entry so the model can
    /// discover and call them individually during a conversation.
    #[must_use]
    pub fn with_patent_workflow_tools(self) -> Self {
        use super::patent_workflow::PatentWorkflowTool;
        self.with_tool(Arc::new(PatentWorkflowTool::new("research")))
            .with_tool(Arc::new(PatentWorkflowTool::new("drafting")))
            .with_tool(Arc::new(PatentWorkflowTool::new("oa-response")))
            .with_tool(Arc::new(PatentWorkflowTool::new("trademark")))
            .with_tool(Arc::new(PatentWorkflowTool::new("creativity")))
            .with_tool(Arc::new(PatentWorkflowTool::new("reexamination")))
            .with_tool(Arc::new(PatentWorkflowTool::new("invalidation")))
            .with_tool(Arc::new(PatentWorkflowTool::new("patent_search")))
